...
$(function() {
    ...
    var ad_lg = '<!-- Home large leaderboard -->' + '<ins class="adsbygoogle"' + 'style="display:inline-block;width:728px;height:90px"' + 'data-ad-client="ca-pub-4495360934352473"' + 'data-ad-slot="1170479443"></ins>' + '<script>' + '(adsbygoogle = window.adsbygoogle || []).push({});' + '</script>';
    var ad_sm = '<!-- AdminLTE -->' + '<ins class="adsbygoogle"' + 'style="display:inline-block;width:300px;height:250px"' + 'data-ad-client="ca-pub-4495360934352473"' + 'data-ad-slot="5866534244"></ins>' + '<script>' + '(adsbygoogle = window.adsbygoogle || []).push({});' + '</script>';

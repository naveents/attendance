            ...
            <div class="box box-grey">
                ...
                <?php
                       $attributes = array('class' => 'form', 'id' => 'batchform');
                        echo form_open('siteadmin/batch/edit/'.$batch['batch_id'],$attributes); ?>
                        ...
                        <div class="form-group">
                                ...
                                <select name="course_id" id="course_id" class="form-control">
                                    ...
                                    <option value="<?php echo $c["course_id"];?>" <?php echo ($c["course_id"] == $batch['course_id'])?"selected":"";?> ><?php echo $c["course_name"];?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class="form-group">
                                ...
                                <select name="academic_year_id" id="academic_year_id" class="form-control">
                                    ...
                                    <option value="<?php echo $a["academic_year_id"];?>" <?php echo ($a["academic_year_id"] == $batch['academic_year_id'])?"selected":"";?>><?php echo date('d/m/Y',strtotime($a["start_year"]))." - ".date('d/m/Y',strtotime($a["end_year"]));?></option>
                                    <?php }?>
                                </select>
                        ...
                        <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="batch_name" name="batch_name" value="<?php echo ($this->input->post('batch_name') ? $this->input->post('batch_name') : $batch['batch_name']); ?>" />
